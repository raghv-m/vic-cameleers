...
export default async function AdminDashboardPage() {
  ...
  const [leadsToday, leadsThisWeek, statusCounts, bookedCount, totalCount, recentLeads] =
    await Promise.all([
  ...
  return (
    <div className="mx-auto max-w-3xl px-4 py-10">
      ...
      <p className="text-muted-foreground mt-8 text-xs">
        Revenue and upcoming moves land once bookings can be created (next Milestone 1C slice).
      </p>
    </div>
  );
}
